...
class K {
    ...
    o() {
        if (something) {
            __turbopack_require__("[project]/turbopack/crates/turbopack-tests/tests/snapshot/comptime/early-return/input/module.js [test] (ecmascript)");
            return;
        } else {
            __turbopack_require__("[project]/turbopack/crates/turbopack-tests/tests/snapshot/comptime/early-return/input/module.js [test] (ecmascript)");
            return;
...
//# sourceMappingURL=4e721_crates_turbopack-tests_tests_snapshot_comptime_early-return_input_82bbae._.js.map