...
- [Adding a loading skeleton to specific route in a common sgement](#opting-loading-skeletons-to-a-specific-route)
...
### Opting loading skeletons to a specific route

To opt a [loading skeleton](/docs/app/building-your-application/routing/loading-ui-and-streaming) via a `loading.js` file to only a specific route, create a new route group (e.g., `/(overview)`) and then move your `loading.tsx` inside that route group.
